...
username1, password1 = "solidrock", hashlib.sha256("5970".encode()).hexdigest()
username2, password2 = "mark", hashlib.sha256("iamkass".encode()).hexdigest()
username3, password3 = "johncole", hashlib.sha256("iamlass".encode()).hexdigest()
username4, password4 = "alpha", hashlib.sha256("iamvass".encode()).hexdigest()
